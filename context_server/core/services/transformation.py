...
class TransformationService:
    ...
    def standardize_search_result_fields(self, result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def standardize_code_search_result_fields(self, result: Dict[str, Any]) -> Dict[str, Any]:
